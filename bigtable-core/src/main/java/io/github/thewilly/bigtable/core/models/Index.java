...
public class Index implements Serializable {
    ...
    private final IndexTree<TableRowLocalizer> _localizers;
     ...
     * @return the index
     */
    public static <T extends Comparable<T>> Index create(String id, IndexAlgorithm indexAlgorithm, Table<T> table) {
